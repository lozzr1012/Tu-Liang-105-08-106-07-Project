...
public class One_MR_FPTree {
    ...
    public static class GroupMapper extends
        ...
        public void setup(Context context) throws IOException {
            ...
            Path freqFile = new Path(fs.getWorkingDirectory().toString() + "/final/part-r-00000");
    ...
    public static void main(String[] args) throws IOException,
        ...
        FileSystem fs = FileSystem.get(conf);
        System.out.println(fs.getWorkingDirectory().toString() +fs.getWorkingDirectory().toString());
        Path inpath = new Path(fs.getWorkingDirectory().toString() + "/dataset");
        Path outpath = new Path(fs.getWorkingDirectory().toString() + "/frequency");
